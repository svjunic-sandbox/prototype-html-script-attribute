...
window.BrightTag = (function(l) {
  ...
  function ea(a, d, c) {
    ...
    function e() {
      try {
        return JSON.stringify({ site: m, referrer: h, errors: q });
      } catch (a) {
    ...
    function k() {
      g();
      q.push(f({ type: 'runtime', message: 'Too many errors' }));
      a.set(d, e());
    }
      ...
      function f(b, d) {
        r(h, function(k) {
          ...
          try {
            ...
            c(
              { type: 'evdbe', message: r.toString(), pageId: B || -1 },
              { name: g, eventName: a }
            );
          }
        });
      ...
      e.trigger = function(e, m, h) {
        ...
        if (!f || z(f, l)) {
          try {
            ...
            c(
              { type: 'evwait', message: y.toString(), tagId: k.tagId || -1 },
              { eventName: a }
            );
          }
          b(h);
    ...
    function m(b) {
      n.hasErrors() &&
        ...
        b.tooLong() &&
          ...
          n.tooManyErrors(),
          b.appendParam('errors', n.toJSON())));
      n.reset({ site: a.site, referrer: a.referrer || q.location.href });
    }
    var h = this,
      v = a.data || {},
      q = a.document || {},
    ...
    return s(g, {
      bind: function(e, f, k, m) {
        ...
        l.on('error', function(a, b) {
          g.emit('error', a, { name: b, eventName: e }, m);
        });
        d.ensureLibrary(function() {
          try {
            d.bind(f, k, h);
          } catch (a) {
            g.emit('error', a, { eventName: e }, m);
          }
        });
        return l;
      },
    ...
    return {
      ...
      'block:error': function(d, c) {
        ...
        c &&
          ...
          (g = c.exception || c),
          (e = d.option('tagId') || -1),
          a.push({ type: b, message: g.toString(), tagId: e }));
      }
    };
  }
  function Ea(a) {
  ...
  function la() {
    ...
    let d;
    return (d = { fire: a, appendData: a, appendJs: a, execute: a, when: a });
  }
  function T(a) {
    function d(a, b) {
  ...
  function Ga(a, d, c, b, g, e) {
    ...
    function k(a) {
      if (null == a || a.hasConditions())
        b.reset({ site: n.site, referrer: n.referrer || window.location.href });
    }
    function m(a) {
      let c = E('//' + r + '/tag')
        .appendParams({
      ...
      return c.appendParams({ errors: b.hasErrors() ? b.toJSON() : null });
    }
    function h(a) {
      if (null == a) return m();
  ...
  var p = {
    ...
    Ha = (function() {
      ...
      let d = {
        JSON: { object: 'JSON', path: '/json2.js' },
        jQuery: {
  ...
  l.each = x.each;
  l.extend = x.extend;
  l.HTTP = { Cookie: S, QueryString: M, URL: E };
  ...
  l.Content = new (function(a) {
    a = a || l.Blab;
    return { iframe: a.iframe, image: a.image, link: a.link, script: a.script };
  })(l.Blab);
  l.V2_RESPONSE = !0;
  l.site = function(a, d) {
    try {
...
function btServe(l) {
  let n = BrightTag,
    u = { referrer: _bt_referrer, site: _bt_site, mode: _bt_mode };
